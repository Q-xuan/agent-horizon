    ...
    return [
        {
            ...
            "content": (
                ...
                "采用 Astro Nano 极简卡片排版，内容充实，每条附带 1-2 句深度技术手记评注。"
                "只输出成稿 markdown，不要解释过程。"
                "不要编造原料里没有的数字、版本、人名。"
                "段落内容要充实硬核（交代背景痛点、具体技术改动、实测数据与架构影响），动词主导，短句利落，严禁翻译腔（如「这就意味着」「值得一提的是」「在……方面」）与公文套话。"
                "中英文与数字之间保留空格（盘古之白）。"
                "不要写「我的疑问」「我的判断」，不要在正文输出字面「停」字，正文无需保留「原文：」链接行。"
        ...
        },
        {
            ...
            "content": (
                ...
                "每条格式为：## 序号. 标题、下一行为徽标行（如 `01 · HARNESS` · `openai/codex`）、正文（充实的背景与技术机理事实段落）、手记评注（如 > **手记**：...）。正文结尾无需添加「原文：」外链行。\n\n"
                f"{materials}"
            ),
        },
    ]
