...
给 AI Agent 工程师的每日雷达。引擎是 [Horizon](https://github.com/Thysrael/Horizon)，源和打分按 coding agent / harness 架构收窄。
...
Daily radar for AI agent engineers. Powered by [Horizon](https://github.com/Thysrael/Horizon), narrowed to coding agents and harness architecture.
